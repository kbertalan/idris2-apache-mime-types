...
export
APPLICATION_VND_DOT_GEOGEBRA_DOT_SLIDES : Mime
APPLICATION_VND_DOT_GEOGEBRA_DOT_SLIDES = MkMime Application "vnd.geogebra.slides" ["ggs"]
...
export
APPLICATION_WASM : Mime
APPLICATION_WASM = MkMime Application "wasm" ["wasm"]
...
MODEL_VND_DOT_MTS = MkMime Model "vnd.mts" []
...
export
VIDEO_MP2T : Mime
VIDEO_MP2T = MkMime Video "mp2t" ["ts", "m2t", "m2ts", "mts"]
...
mimes =
  ...
  , APPLICATION_VND_DOT_GEOGEBRA_DOT_SLIDES
...
extensions =
  ...
  , ("ggs", APPLICATION_VND_DOT_GEOGEBRA_DOT_SLIDES)
